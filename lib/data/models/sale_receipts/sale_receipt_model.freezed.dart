...
mixin _$SaleReceiptModel {
 ...
 String? get id; String? get customerName; String? get preparedBy; dynamic get paymentMode; PaymentStatus get paymentStatus; String? get paymentRef; String? get orderNo; String? get unitId; List<BillItemModel>? get billItems; int? get totalAmount; DateTime? get createdAt; DateTime? get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SaleReceiptModel&&(identical(other.id, id) || other.id == id)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.preparedBy, preparedBy) || other.preparedBy == preparedBy)&&const DeepCollectionEquality().equals(other.paymentMode, paymentMode)&&(identical(other.paymentStatus, paymentStatus) || other.paymentStatus == paymentStatus)&&(identical(other.paymentRef, paymentRef) || other.paymentRef == paymentRef)&&(identical(other.orderNo, orderNo) || other.orderNo == orderNo)&&(identical(other.unitId, unitId) || other.unitId == unitId)&&const DeepCollectionEquality().equals(other.billItems, billItems)&&(identical(other.totalAmount, totalAmount) || other.totalAmount == totalAmount)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,customerName,preparedBy,const DeepCollectionEquality().hash(paymentMode),paymentStatus,paymentRef,orderNo,unitId,const DeepCollectionEquality().hash(billItems),totalAmount,createdAt,updatedAt);

@override
String toString() {
  return 'SaleReceiptModel(id: $id, customerName: $customerName, preparedBy: $preparedBy, paymentMode: $paymentMode, paymentStatus: $paymentStatus, paymentRef: $paymentRef, orderNo: $orderNo, unitId: $unitId, billItems: $billItems, totalAmount: $totalAmount, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String? id, String? customerName, String? preparedBy, dynamic paymentMode, PaymentStatus paymentStatus, String? paymentRef, String? orderNo, String? unitId, List<BillItemModel>? billItems, int? totalAmount, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of SaleReceiptModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? customerName = freezed,Object? preparedBy = freezed,Object? paymentMode = freezed,Object? paymentStatus = null,Object? paymentRef = freezed,Object? orderNo = freezed,Object? unitId = freezed,Object? billItems = freezed,Object? totalAmount = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? customerName,  String? preparedBy,  dynamic paymentMode,  PaymentStatus paymentStatus,  String? paymentRef,  String? orderNo,  String? unitId,  List<BillItemModel>? billItems,  int? totalAmount,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaleReceiptModel() when $default != null:
return $default(_that.id,_that.customerName,_that.preparedBy,_that.paymentMode,_that.paymentStatus,_that.paymentRef,_that.orderNo,_that.unitId,_that.billItems,_that.totalAmount,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _SaleReceiptModel implements SaleReceiptModel {
  const _SaleReceiptModel({this.id, this.customerName, this.preparedBy, this.paymentMode = PaymentMode.cash, this.paymentStatus = PaymentStatus.receivable, this.paymentRef, this.orderNo, this.unitId, final  List<BillItemModel>? billItems, this.totalAmount, this.createdAt, this.updatedAt}): _billItems = billItems;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SaleReceiptModel&&(identical(other.id, id) || other.id == id)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.preparedBy, preparedBy) || other.preparedBy == preparedBy)&&const DeepCollectionEquality().equals(other.paymentMode, paymentMode)&&(identical(other.paymentStatus, paymentStatus) || other.paymentStatus == paymentStatus)&&(identical(other.paymentRef, paymentRef) || other.paymentRef == paymentRef)&&(identical(other.orderNo, orderNo) || other.orderNo == orderNo)&&(identical(other.unitId, unitId) || other.unitId == unitId)&&const DeepCollectionEquality().equals(other._billItems, _billItems)&&(identical(other.totalAmount, totalAmount) || other.totalAmount == totalAmount)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,customerName,preparedBy,const DeepCollectionEquality().hash(paymentMode),paymentStatus,paymentRef,orderNo,unitId,const DeepCollectionEquality().hash(_billItems),totalAmount,createdAt,updatedAt);
...
/// Create a copy of SaleReceiptModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? customerName = freezed,Object? preparedBy = freezed,Object? paymentMode = freezed,Object? paymentStatus = null,Object? paymentRef = freezed,Object? orderNo = freezed,Object? unitId = freezed,Object? billItems = freezed,Object? totalAmount = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
